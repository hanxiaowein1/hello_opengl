...
The second mode is view it by model mode. Imagine that you sit on a table, and your model is fixed on the table, you can let your model rotate, and you can put your eye closer or further to watch it. This interface is called show_triangles_with_model_viewer().
